    ...
    render() {
        ...
        return (
            <div className="auth-page">
                <Container>
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Dev League</h3>}>
                ...
                {new Date().getFullYear()} &copy; Dev League - Webapp powered by <a href="https://daylight.com" rel="noopener noreferrer" target="_blank">Daylight</a>.
                </footer>
            </div>
        );
    }
